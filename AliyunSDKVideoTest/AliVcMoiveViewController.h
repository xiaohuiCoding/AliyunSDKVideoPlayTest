...
@interface AliVcMoiveViewController : UIViewController
...
/**
 *  设置播放的视频地址，需要在视图启动之前设置
 *  参数url为本地地址或网络地址
 *  如果为本地地址，则需要用[NSURL fileURLWithPath:path]初始化NSURL
 *  如果为网络地址，则需要用[NSURL URLWithString:path]初始化NSURL
 */
